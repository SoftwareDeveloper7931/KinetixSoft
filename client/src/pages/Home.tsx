    ...
    <div className="min-h-screen relative" style={{ background: "#0A0E14" }}>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6 py-20">
            <div className="flex flex-col items-center text-center w-full">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                <span
                  className="inline-block px-4 py-1 text-xs font-semibold uppercase tracking-widest mb-6"
                  style={{ border: "1px solid #232A36", borderRadius: "6px", color: "#8A93A3", background: "rgba(74,95,189,0.08)" }}
                >
              ...
              <motion.h1
                ...
                style={{ color: "#E9EBEF", fontFamily: "Newsreader, Georgia, serif", fontWeight: 500 }}
              >
                The <em className="text-gradient not-italic">KinetixSoft</em> is Here <br />
      ...
      <section className="py-24 px-4 md:px-6 max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl" style={{ color: "#E9EBEF" }}>
            What You Actually <em style={{ color: "#4A5FBD", fontStyle: "italic" }}>Get</em>
          </h2>
        </motion.div>
            ...
            <div className="p-8 flex flex-col justify-center">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="ml-auto flex gap-0.5">
                  {[...Array(5)].map((_, i) => <Star key={i} className="w-4 h-4" style={{ fill: "#C9A86A", color: "#C9A86A" }} />)}
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 px-4 md:px-6 max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl mb-4" style={{ color: "#E9EBEF" }}>
            Pick Your <em style={{ color: "#4A5FBD", fontStyle: "italic" }}>Platform</em>
          </h2>
      ...
      <section className="py-24 px-4 md:px-6 max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl mb-6" style={{ color: "#E9EBEF" }}>
            Where We <em style={{ color: "#4A5FBD", fontStyle: "italic" }}>Focus</em>
          </h2>
          <p className="text-lg leading-relaxed" style={{ color: "#8A93A3" }}>
        ...
        <div className="overflow-hidden" style={{ background: "#12161F", border: "1px solid #232A36", borderRadius: "6px" }}>
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative p-12 flex items-center justify-center min-h-[300px]"
            ...
            >
              ...
              <h2 className="text-3xl mb-5" style={{ color: "#E9EBEF" }}>
                Why This Actually <em style={{ color: "#4A5FBD", fontStyle: "italic" }}>Works</em>
              </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {[
            ...
            >
              ...
              <h3 className="text-xl font-semibold" style={{ color: "#E9EBEF" }}>
                {c.title} <em style={{ color: "#4A5FBD", fontStyle: "italic" }}>{c.accent}</em>{c.rest}
              </h3>
            </motion.div>
          ))}
        </div>
        ...
        <div className="overflow-hidden" style={{ background: "#12161F", border: "1px solid #232A36", borderRadius: "6px" }}>
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="relative min-h-[280px] flex items-center justify-center p-10"
              style={{ background: "#161B26", borderLeft: "1px solid #232A36" }}
            >
      ...
      <section className="py-24 px-4 md:px-6 max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg mb-8 leading-relaxed" style={{ color: "#8A93A3" }}>
          ...
          >
            <div className="p-8" style={{ background: "#12161F", border: "1px solid #232A36", borderRadius: "6px" }}>
              <h3 className="text-2xl font-semibold mb-2 text-center" style={{ color: "#E9EBEF" }}>
                Let's Get <em style={{ color: "#4A5FBD", fontStyle: "italic" }}>Started</em>
              </h3>
        ...
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <h2 className="text-4xl md:text-5xl mb-5" style={{ color: "#E9EBEF" }}>
              We Should <em style={{ color: "#4A5FBD", fontStyle: "italic" }}>Talk</em>
            </h2>
