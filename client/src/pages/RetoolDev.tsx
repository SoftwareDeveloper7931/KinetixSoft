        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <h1 className="text-4xl md:text-5xl xl:text-6xl leading-tight mb-6" style={{ color: "#E9EBEF" }}>
              ...
              <em style={{ color: "#4A5FBD", fontStyle: "italic" }}>Your</em> Data
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/contact">
                <button
                  ...
                  data-testid="button-retool-hero-start"
              ...
              <Link href="/contact">
                <button
                  ...
                  data-testid="button-retool-hero-schedule"
      ...
      <section className="py-20 px-4 md:px-6 max-w-7xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl mb-4" style={{ color: "#E9EBEF" }}>
            ...
            <em style={{ color: "#4A5FBD", fontStyle: "italic" }}>Retool Partner</em>?
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="flex flex-col justify-center">
            <h2 className="text-3xl md:text-4xl mb-5" style={{ color: "#E9EBEF" }}>
              ...
              <em style={{ color: "#4A5FBD", fontStyle: "italic" }}>Spreadsheets and SQL</em>?
            </h2>
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="p-8" style={{ background: "#12161F", border: "1px solid #232A36", borderRadius: "6px" }}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <input {...register("name", { required: true })} placeholder="Full Name *" data-testid="input-retool-name" className="w-full px-4 py-3 focus:outline-none" style={{ background: "#161B26", border: "1px solid #232A36", borderRadius: "6px", color: "#E9EBEF" }} />
              <input {...register("email", { required: true })} type="email" placeholder="Email Address *" data-testid="input-retool-email" className="w-full px-4 py-3 focus:outline-none" style={{ background: "#161B26", border: "1px solid #232A36", borderRadius: "6px", color: "#E9EBEF" }} />
              <input {...register("phone", { required: true })} placeholder="Phone Number *" data-testid="input-retool-phone" className="w-full px-4 py-3 focus:outline-none" style={{ background: "#161B26", border: "1px solid #232A36", borderRadius: "6px", color: "#E9EBEF" }} />
              <input {...register("country", { required: true })} placeholder="Country *" data-testid="input-retool-country" className="w-full px-4 py-3 focus:outline-none" style={{ background: "#161B26", border: "1px solid #232A36", borderRadius: "6px", color: "#E9EBEF" }} />
              <textarea {...register("message")} placeholder="Tell us about your business" data-testid="input-retool-message" rows={4} className="w-full px-4 py-3 focus:outline-none resize-none" style={{ background: "#161B26", border: "1px solid #232A36", borderRadius: "6px", color: "#E9EBEF" }} />
        ...
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <h2 className="text-4xl md:text-5xl mb-5" style={{ color: "#E9EBEF" }}>
              Ready to Get Off <em style={{ color: "#4A5FBD", fontStyle: "italic" }}>Manual Ops</em>?
            </h2>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/contact">
                <button
                  className="h-12 px-8 text-sm font-semibold transition-colors"
                  style={{ background: "#4A5FBD", color: "#E9EBEF", borderRadius: "6px", border: "none", cursor: "pointer" }}
                  data-testid="button-retool-cta-start"
                  onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.background = "#5A6FCC"; }}
                  onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.background = "#4A5FBD"; }}
                >
                  Start Your Project
              ...
              <Link href="/contact">
                <button
                  className="h-12 px-8 text-sm font-semibold transition-colors flex items-center gap-2"
                  style={{ background: "transparent", color: "#E9EBEF", borderRadius: "6px", border: "1px solid #232A36", cursor: "pointer" }}
                  data-testid="button-retool-cta-call"
                  onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.borderColor = "#4A5FBD"; }}
                  onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.borderColor = "#232A36"; }}
                >
