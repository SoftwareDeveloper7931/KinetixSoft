    ...
    <div className="min-h-screen bg-[#0B0F19]">
      <section className="pt-36 pb-24 px-4 md:px-6 max-w-3xl mx-auto relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="text-4xl md:text-5xl mb-4" style={{ color: "#E9EBEF", fontFamily: "var(--font-display)", fontWeight: 500 }}>Privacy Policy</h1>
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-8" style={{ color: "#8A93A3" }}>
          <section>
            <h2 style={{ color: "#E9EBEF", fontFamily: "var(--font-display)", fontSize: "1.5rem", marginBottom: "0.75rem" }}>Information We Collect</h2>
          ...
          <section>
            <h2 style={{ color: "#E9EBEF", fontFamily: "var(--font-display)", fontSize: "1.5rem", marginBottom: "0.75rem" }}>How We Use Your Information</h2>
          ...
          <section>
            <h2 style={{ color: "#E9EBEF", fontFamily: "var(--font-display)", fontSize: "1.5rem", marginBottom: "0.75rem" }}>Data Storage & Security</h2>
          ...
          <section>
            <h2 style={{ color: "#E9EBEF", fontFamily: "var(--font-display)", fontSize: "1.5rem", marginBottom: "0.75rem" }}>Third-Party Services</h2>
          ...
          <section>
            <h2 style={{ color: "#E9EBEF", fontFamily: "var(--font-display)", fontSize: "1.5rem", marginBottom: "0.75rem" }}>Your Rights</h2>
          ...
          <section>
            <h2 style={{ color: "#E9EBEF", fontFamily: "var(--font-display)", fontSize: "1.5rem", marginBottom: "0.75rem" }}>Cookies</h2>
          ...
          <section>
            <h2 style={{ color: "#E9EBEF", fontFamily: "var(--font-display)", fontSize: "1.5rem", marginBottom: "0.75rem" }}>Contact Us</h2>
